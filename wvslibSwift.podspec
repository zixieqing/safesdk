...
Pod::Spec.new do |s|
  ...
  s.summary          = 'A short description of wvslibSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/admin/wvslibSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'admin' => 'admin' }
  s.source           = { :git => 'https://github.com/admin/wvslibSwift.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'
  
  s.source_files = 'wvs/*.h','wvslibSwift/Classes/**/*'
